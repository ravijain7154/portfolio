const Resume = ({name}) => {
    return(
      <div className="resume-container mt-4" id="resume-section">
        <div className="side-card">
            <div className="side-img-box">
                <div className="side_card_content">
                   <iframe src={`/updated_Ravi_CV.pdf`} title="My Professional Resume Document" className="iframe" width={'100%'} height={"700px"}></iframe>
                </div>
            </div>
